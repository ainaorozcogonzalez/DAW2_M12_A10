                ...
                <div class="rounded-md shadow-sm space-y-4">
                    <div>
                        ...
                        <input id="email" name="email" type="email" autocomplete="email"
                            ...
                            placeholder="Correo electrónico" value="admin@incidencias.com">
                        <div id="email-error" class="text-red-500 text-sm mt-1 hidden">Por favor, introduce un email
                            válido.</div>
                    </div>
                    <div>
                        ...
                        <div id="password-error" class="text-red-500 text-sm mt-1 hidden">La contraseña debe tener al
